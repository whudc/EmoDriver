...
class ModelArguments:
    feature_len: Optional[int] = field(default=80, metadata={"help": "The length of the feature."})
    ...
    dataset_cache: Optional[str] = field(default='./dataset_cache', metadata={"help": "Path to the dataset cache"})
